...
git clone https://github.com/potatopeelings/cheat ~/usr/local/scripts/potatopeelings-cheat

# add to ~/.bashrc and reload
echo 'alias cheat='\''"~/usr/local/scripts/potatopeelings-cheat/src/cheat.sh"'\''' >> ~/.bashrc
source ~/.bashrc
```
